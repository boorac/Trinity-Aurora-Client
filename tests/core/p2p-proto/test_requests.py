...
from p2p.aurora.util import aurora_head_v2
...
async def test_proxy_peer_requests(request,
    ...
    async with run_peer_pool_event_server(
        ...
        head_hash_other = await aurora_head_v2(proxy_peer.session.remote, other_event_bus)
        assert head_hash_other == head_hash
